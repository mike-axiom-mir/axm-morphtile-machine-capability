...
- IMPLEMENTED: the tiny adapter, local envelope, fail-closed intent compiler, safe-integer initial-state compiler, fail-closed wake compiler, and fixtures used by the tests.
- TESTED: deterministic candidate generation, malformed/unknown intent HOLD behavior, invalid-initial HOLD behavior, unsupported-intent HOLD behavior, wake-contract HOLD behavior, and counter/sleeping-counter integration assertions against MorphTile commit `4346df01ed18cd1336064f9323d7766ff4f6338a`.
